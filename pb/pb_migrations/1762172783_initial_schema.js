...
migrate((app) => {
  const snapshot = [
    ...
    {
      "createRule": "@request.auth.id != \"\"",
      "deleteRule": "@request.auth.id != \"\" && batch.project.user = @request.auth.id",
      "fields": [
        {
          "autogeneratePattern": "[a-z0-9]{15}",
          "hidden": false,
      ...
      "id": "pbc_3607937828",
      "indexes": [],
      "listRule": "@request.auth.id != \"\" && batch.project.user = @request.auth.id",
      "name": "images",
      "system": false,
      "type": "base",
      "updateRule": "@request.auth.id != \"\" && batch.project.user = @request.auth.id",
      "viewRule": "@request.auth.id != \"\" && batch.project.user = @request.auth.id"
    }
  ];
